...
button_frame.place(relx=.66, rely=.11, anchor="c")
...
drop2.config(width = 25, height= 1)
...
data_print_button = Button(button_frame, text="Εμφάνιση Δημοσιεύσεων Καθηγητή", font=("Helvetica", 10),bg="WHITE", command=data_print)

# κουμπι εισαγωγης δεδομενων
import_jsonfile_button = Button(button_frame, text="Προσθήκη αρχείου JSON", width=23 , font=("Helvetica", 10), command=import_jsonfile)

# κουμπι καθαρισμου πινακα
clear_text_button = Button(button_frame, text="Καθαρισμός", font=("Helvetica", 10),  command=clear_data)

# κουμπι εισαγωγης καθηγητη
add_person_button = Button(button_frame, text="Προσθηκη νεου καθηγητη", width=26 , font=("Helvetica", 10), command= add_person_creation)

# κουμπι διαγραφης καθηγητη
del_person_button = Button(button_frame, text="Διαγραφη Καθηγητή",width=23 , font=("Helvetica", 10), command=delete_person_creation)

# κουμπι πληροφοριων καθηγητη
scholar_info_button = Button(button_frame, text="Scholar Info", font=("Helvetica", 10), command=scholar_info)
