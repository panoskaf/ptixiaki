...
def add_person_creation():
    ...
    pop.config(bg="#2f929c")
    pop.geometry("650x150+400+300")
    
    pop_label = Label(pop, text="Όνομα με Ελληνικούς χαρακτήρες :",  font=("helvetica", 12),bg="#2f929c")
    pop_label.grid(row=0, column=0, padx=10 ,pady=10)
    
    pop_label2 = Label(pop, text="Όνομα με Λατινικούς χαρακτήρες :",  font=("helvetica", 12),bg="#2f929c")
    pop_label2.grid(row=1, column=0, padx=10,pady=10)
 
    pop_label3 = Label(pop, text="Κωδικός Google Scholar ID :",  font=("helvetica", 12),bg="#2f929c")
...
def scholar_info():
    ...
    if clicked.get() != "Επιλέξτε Καθηγητή":
        ...
        el = Button(pop, text="Ελληνικά",height =" 2", width = "8" , bg='#d8dbd7',activeforeground="blue", command=el_copy)
        el.place(relx=.05,rely=.12)
        
        en = Button(pop, text="Λατινικά",height =" 2", width = "8" , bg='#d8dbd7',activeforeground="blue", command=en_copy)
        en.place(relx=.27,rely=.12)
        
        id = Button(pop, text="Scholar ID",height =" 2", width = "8" , bg='#d8dbd7',activeforeground="blue", command=id_copy)
...
def on_double_click(event):
    ...
    #Labels
    id = Label(pop, text="ID",bg="#2f929c" )
    type = Label(pop, text="Type",bg="#2f929c")  
    title = Label(pop, text="Title",bg="#2f929c")
    author = Label(pop, text="Authors",bg="#2f929c")
    year = Label(pop, text="Year",bg="#2f929c")
    source = Label(pop, text="Source",bg="#2f929c")
    cites = Label(pop, text="Cites",bg="#2f929c")
...
tree_frame.place(relx=0.5, rely=0.25, relwidth=0.98, relheight=0.73, anchor='n')
