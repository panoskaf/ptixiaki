...
def results(*args):
    ...
    if function_number == 0:
        ...
        text = Text(pop, height =" 40", width = "25")
        text.grid(row=0, column=1, padx=10,pady=10)
        ...
        ok.grid(row=0, column=1, padx=10, pady=10) 
        ok.place(relx=.05, rely=.94) 
        ...
        figure1, ax = plt.subplots(figsize=(14,6.5))
        ...
        text = Text(pop, height =" 40", width = "27")
        text.grid(row=0, column=1, padx=10,pady=10)
        ...
        text = Text(pop, height =" 40", width = "22")
        text.grid(row=0, column=1, padx=10,pady=10)
        ...
        figure1, ax = plt.subplots(figsize=(14.2, 7))
...
panel.place(relx=.16, rely=.12, anchor="c")

#Πλαισιο κουμπιων
button_frame = Frame(root)
button_frame.configure(height= 2, bg="#2f929c" )
button_frame.pack(fill=None, expand=False)
button_frame.place(relx=.66, rely=.1, anchor="c")
...
drop.config(bg="WHITE", fg="BLACK", activebackground='#32667d', activeforeground='white')
drop.config(width = 25, height= 2)
...
drop2.config(bg="WHITE", fg="BLACK", activebackground='#32667d', activeforeground='white')
drop2.config(width = 25, height= 2)
...
data_print_button = Button(button_frame, text="Εμφάνιση Δημοσιεύσεων Καθηγητή", font=("Helvetica", 10), height =(2) ,bg="WHITE", command=data_print)

# κουμπι εισαγωγης δεδομενων
import_jsonfile_button = Button(button_frame, text="Προσθήκη αρχείου JSON", width=23, height =(2) , font=("Helvetica", 10), command=import_jsonfile)

# κουμπι καθαρισμου πινακα
clear_text_button = Button(button_frame, text="Καθαρισμός", font=("Helvetica", 10), height =(2),  command=clear_data)

# κουμπι εισαγωγης καθηγητη
add_person_button = Button(button_frame, text="Προσθηκη νεου καθηγητη", width=26 , font=("Helvetica", 10), height =(2), command= add_person_creation)

# κουμπι διαγραφης καθηγητη
del_person_button = Button(button_frame, text="Διαγραφη Καθηγητή",width=23 , font=("Helvetica", 10), height =(2), command=delete_person_creation)

# κουμπι πληροφοριων καθηγητη
scholar_info_button = Button(button_frame, text="Scholar Info", font=("Helvetica", 10), height =(2), command=scholar_info)

# κουμπι εξοδου εφαρμογης
quit_button = Button(button_frame, text=" Έξοδος", font=("Helvetica", 16), bg="#d13636", command= root.quit)
...
# create tree frame
tree_frame = Frame(root, width = 1500, height = 670)

# Create Vertical Scrollbar
tree_scroll = Scrollbar(tree_frame)
tree_scroll.pack(side=tk.RIGHT, fill=tk.Y)

my_tree = ttk.Treeview(tree_frame, yscrollcommand=tree_scroll.set,height = 29, selectmode="extended")
my_tree.pack()
...
my_tree.column("ID", anchor=tk.W, width=150)
my_tree.column("TYPE", anchor=tk.CENTER, width=140)
my_tree.column("TITLE", anchor=tk.W, width=620)
my_tree.column("AUTHORS", anchor=tk.W, width=300)
my_tree.column("YEAR", anchor=tk.CENTER, width=40)
my_tree.column("SOURCE", anchor=tk.W, width=160)
...
#grid widgets
drop.grid(row=0, column=0, padx=10,pady=10) #lista ka8igiton  
drop2.grid(row=0, column=2, padx=10,pady=10) #lista leitoyrgion  
import_jsonfile_button.grid(row=1, column=0) # json file
data_print_button.grid(row=0, column=1 ) # emfanisi
clear_text_button.grid(row=0, column=3,padx=10) #ka8arismo
add_person_button.grid(row=1, column=1,padx=10, sticky=tk.W) # pros8iki neoy
del_person_button.grid(row=1, column=2,padx=10) # diagrafi
scholar_info_button.grid(row=1, column=3,padx=10, pady=15 ) # info
quit_button.grid(columnspan=3, rowspan=2, row=0, column=4 , padx=10) # exodos
tree_frame.grid(row=3, rowspan=4,columnspan=5, pady=10) # tree frame
